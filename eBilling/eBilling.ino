...
void setup() {
  ...
  //sendGSM("AT+HTTPPARA=\"URL\",\"http://www.ceb-ebilling.000webhostapp.com/ceb/add.php?acid='AC00010'&unit="+sumKWH+"\"");
//sendGSM(sumKWH);
//sendGSM("\"");
...
//
//
////SIM900.print("AT+HTTPPARA=\"URL\",\"http://www.ceb-ebilling.000webhostapp.com/ceb/add.php?acid='AC00010'&unit=");
////SIM900.print(sumKWH);
////SIM900.println("\"");
//  
...
//  runsl();
//  delay(100);
//  SIM900.println("AT+HTTPDATA=192,10000");
//  runsl();
//  delay(100);
//
//SIM900.println("acid='AC00010'&unit=");
//  runsl();
//  delay(10000);
//  
//  SIM900.println(sumKWH);
//  runsl();
//  delay(10000);
...
//  ShowSerialData();
// 
//  SIM900.println("AT+SAPBR=3,1,\"APN\",\"dialogbb\"");//setting the APN, Access point name string
//  delay(4000);
// 
//  ShowSerialData();
// 
...
//
// 
////  SIM900.println("AT+HTTPPARA=\"URL\",\"http://ceb-ebilling.000webhostapp.com/ceb/add.php?"); // setting the httppara, the second parameter is the website you want to access
////  SIM900.println("acid=AC00010");
////  SIM900.println("&unit=");
////  SIM900.println(sumKWH);
////  SIM900.println("\"");
//
////SIM900.println("AT+HTTPPARA=\"URL\",\"http://www.cebebilling.000webhostapp.com/add.php?acid=AC00001&unit=22\"");
//
//SIM900.print("AT+HTTPPARA=\"URL\",\"http://www.ceb-ebilling.000webhostapp.com/ceb/add.php?acid='AC00010'&unit=");
//SIM900.print(sumKWH);
//SIM900.println("\"");
...
{
  sendGSM("AT+CLIP=1\r");
  sendGSM("AT+CMGF=1");    // Setting the GSM Module in Text mode
  delay(1000);  
  sendGSM("AT+CMGS=\"0772088783\"\r"); // Sending Energy Consumption to Customer's Mobile Number
  delay(1000);
  
    sendGSM("Dear Customer, Your Energy Consumption is :");
   sendGSM((char)sumKWH);
    sendGSM(" and Total Billing is Rs. ");
    sendGSM(char(sumRupees));
  
  delay(100);
  sendGSM((char)26); // ASCII code of CTRL+Z
  delay(100);
}
